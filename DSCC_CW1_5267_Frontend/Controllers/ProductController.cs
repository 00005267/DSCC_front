...
using DSCC_CW1_5267_Front.Models;


namespace DSCC_CW1_5267_Front.Controllers
{
    public class ProductController : Controller
    {
        ...
        private List<Product> Get()
        {
            try
            {
                ...
                var getDataTask = client.GetAsync("http://35.173.201.122/api/product").ContinueWith(response => {
        ...
        public ActionResult Create(Product product)
        {
            ...
            {
                client.BaseAddress = new Uri("http://35.173.201.122/api/product");
        ...
        public ActionResult Edit(Product product)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri("http://35.173.201.122/api/product" + product.ProductId);
